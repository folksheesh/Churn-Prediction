    ...
    <div className="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div className="bg-white py-8 px-4 shadow-sm border border-zinc-200/80 sm:rounded-xl sm:px-10">
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <h2 className="text-lg font-semibold text-zinc-900">Create an account</h2>
            <p className="mt-1 text-sm text-zinc-500">Get started with your operational workspace.</p>
          </div>
